...
get_header(); ?>
    <div class="breadcrumb">
        <div class="container">
			...
			$category = get_category(get_the_category()[0]->cat_ID);
			if ( $parent && $category->category_parent > 0 ):?>
				<? echo $parent ?>
                /
			<? endif; ?>
    ...
    <section>
        <div class="container">
            ...
            <div class="section">
				...
				<?php if ( have_posts() && ! (is_category( '13' ) || is_category( '5' ) || is_category( '12' )) ) : while ( have_posts() ) : the_post(); ?>
